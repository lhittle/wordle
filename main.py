...
def get_guess(user_input):
  ...
  while len(user_input)!=5 or user_input not in all_words:
    user_input=(input("Invalid guess! Try again!\n")).upper()
  if len(user_input)==5 and user_input in all_words:
    return user_input  
...
def wordle():
  ...
  if guess==answer:
    ...
    print("You got it! It took you one try!")
  if guess!=answer:
  ...
  if guess==answer:
    print(correct_format+guess)
    print(f"You got it! It took you {6-num_guesses} tries.")
  if guess!=answer and num_guesses==0:
    print(f"You're out of guesses! The correct word was {answer}.")
print(wordle())
